...
namespace {
    ...
    public:
        ...
        MediaConverter(ProcessCallback *callback, const char *sourcePath, const char *targetPath,
                       const char *format);
...
//        write_audio_frame_immediate(audioFrame);
    ...
    MediaConverter::MediaConverter(ProcessCallback *callback, const char *sourcePath,
